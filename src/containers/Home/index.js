                ...
                <tbody>
                  {order.orders.length > 0
                    ? order.orders.map((orderItem, index) => {
                        let CompletedItems = orderItem.orderStatus.filter(
                          (od, index) => od.isCompleted
                        );
                        let item = CompletedItems?.length
                        ...
                        return (
                          <tr key={index} style={{ lineHeight: "1.5" }}>
                            ...
                            <td
                              className={`horderStatus ${
                                item.isCompleted && item.type == "delivered"
                                  ? "active"
                                  : null
                              }`}>
                              {" "}
